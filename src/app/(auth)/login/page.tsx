...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      setFormError("An error occurred with Google sign-in.");
      setIsLoading(false);
    }
  };

  const errorMessage =
    error === "AccessDenied" ? "You don't have access to this application."
    : error === "Callback" ? "There was an error signing you in."
    : formError;
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm space-y-8 animate-fade-in-up">
        ...
        {/* Form */}
        <div className="p-6 rounded-xl border border-border bg-card shadow-elevation-2">
